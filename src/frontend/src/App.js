...
const removeStudent = (studentId, callback) => {
    deleteStudent(studentId).then(() => {
        successNotification( "Student deleted", `Student with studentId ${studentId} was deleted`);
        callback();
    }).catch(err => {
        err.response.json().then(res =>{
            console.log(res);
            errorNotification(`unable to delete the student.`, `${res.message} [${res.status}][${res.error}]`);
        })    });
}
    ...
    return <Layout style={{minHeight: '100vh'}}>
        ...
        <Layout className="site-layout">
            ...
            <Footer style={{textAlign: 'center'}}>
                ...
                <Divider>
                    <a target="_blank" rel="noreferrer" href="https://www.eyeruw.com">Click hear to learn about the developer</a>
                </Divider>
